...
"C:\SonarQube\sonar-scanner-msbuild-4.0.2.892\SonarQube.Scanner.MSBuild.exe" begin ^
	/k:"OfficeMap" /n:"Office map" /v:"%datetime%" ^
...
set test1="OfficeMap.Data.Tests\bin\Debug\netcoreapp2.0\OfficeMap.Data.Tests"
set test2="OfficeMap.Web.Tests\bin\Debug\netcoreapp2.0\OfficeMap.Web.Tests"
set test3="OfficeMap.Business.Tests\bin\Debug\netcoreapp2.0\OfficeMap.Business.Tests"
...
"C:\SonarQube\Tools\OpenCover.4.6.519\tools\OpenCover.Console.exe" ^
	...
	-searchdirs:"OfficeMap.Data.Tests\bin\Debug\netcoreapp2.0";"OfficeMap.Web.Tests\bin\Debug\netcoreapp2.0";"OfficeMap.Business.Tests\bin\Debug\netcoreapp2.0" ^
	-oldStyle
